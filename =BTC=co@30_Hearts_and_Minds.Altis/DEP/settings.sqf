...
// dep_logging = true;
   ...
   dep_safe_zone = getMarkerPos "dep_safezone_marker_1";
   dep_safe_rad = 3000;
// dep_map_margin = 400;
   dep_ieds = false;
   dep_mines = false;
...
// dep_ground_vehicles = ["I_C_Offroad_02_unarmed_F","I_C_Van_01_transport_F","I_G_Van_01_transport_F","I_G_Offroad_01_armed_F","O_T_Truck_03_transport_ghex_F"];
   dep_air_vehicles     = ["rhs_tigr_3camo_msv","RHS_Su25SM_KH29_vvs","RHS_Mi8AMTSh_vvs","RHS_Ka52_UPK23_vvsc","RHS_Mi24V_FAB_vvs","O_T_VTOL_02_infantry_grey_F","RHS_Mi8MTV3_vvs"];
